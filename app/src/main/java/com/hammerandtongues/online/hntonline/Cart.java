...
public class Cart  extends AppCompatActivity
    ...
    private static final String GETSTORE_PRODUCTS_URL = "https://hammerandtongues.com/shopping/webservice/getcartitems.php";
    private static final String CREATE_ORDERS_URL = "https://hammerandtongues.com/shopping/webservice/createorder.php";
                ...
                btnDel.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View arg0) {
                        ...
                        new AlertDialog.Builder(Cart.this)
                                ...
                                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        Snackbar snackbar = Snackbar
                                                .make(cartview, name + " Removed from Cart! ", Snackbar.LENGTH_LONG);
                                ...
                                .setMessage(Html.fromHtml("Remove " + name + " from Cart?" ))
                                .show();
